...
//    public ResponseEntity<?> deleteOneProductInCart(@RequestParam Integer cartItemId) {
//        return ResponseEntity.ok(cartService.deleteOneItemInCartItem(cartItemId));
//    }
//
//    @DeleteMapping("cart/deleteAll")
//    public ResponseEntity<?> deleteAllProductInCart(@RequestParam Integer cartItemId) {
